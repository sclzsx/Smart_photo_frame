...
void Test_Color(void)  
{
	...
	Show_Str1(lcddev.width-50,30,BLUE,YELLOW,"White",16,1);delay_ms(500);
	LCD_Fill(0,0,lcddev.width,lcddev.height-0,BLACK);
	Show_Str1(lcddev.width-50,30,BLUE,YELLOW,"Black",16,1);delay_ms(500);
	LCD_Fill(0,0,lcddev.width,lcddev.height-0,RED);
	Show_Str1(lcddev.width-50,30,BLUE,YELLOW,"Red",16,1); delay_ms(500);
	LCD_Fill(0,0,lcddev.width,lcddev.height-0,GREEN);
	Show_Str1(lcddev.width-50,30,BLUE,YELLOW,"Green",16,1);delay_ms(500);
	LCD_Fill(0,0,lcddev.width,lcddev.height-0,BLUE);
	Show_Str1(lcddev.width-50,30,WHITE,YELLOW,"Blue",16,1);delay_ms(500);
...
void English_Font_test(void)
{
	...
	POINT_COLOR=RED;
	BACK_COLOR=BLUE;
	LCD_ShowString1(10,30,12,"6X12:abcdefghijklmnopqrstuvwxyz0123456789",0);
	LCD_ShowString1(10,45,12,"6X12:ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789",1);
	LCD_ShowString1(10,60,12,"6X12:~!@#$%^&*()_+{}:<>?/|-+.",0);
	LCD_ShowString1(10,80,16,"8X16:abcdefghijklmnopqrstuvwxyz0123456789",0);
	LCD_ShowString1(10,100,16,"8X16:ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789",1);
	LCD_ShowString1(10,120,16,"8X16:~!@#$%^&*()_+{}:<>?/|-+.",0); 
	delay_ms(1200);
}
...
{	
	...
	Show_Str1(10,30,BLUE,YELLOW,"16X16:全动电子技术有限公司欢迎您",16,0);
	Show_Str1(10,50,BLUE,YELLOW,"16X16:Welcome全动电子",16,1);
	Show_Str1(10,70,BLUE,YELLOW,"24X24:深圳市中文测试",24,1);
	Show_Str1(10,100,BLUE,YELLOW,"32X32:字体测试",32,1);
	delay_ms(1200);
}
...
//	Show_Str1(30+12,75,BLUE,YELLOW,"QQ",16,1);
//	Gui_Drawbmp16(90,30,gImage_qq);
//	Show_Str1(90+12,75,BLUE,YELLOW,"QQ",16,1);
//	Gui_Drawbmp16(150,30,gImage_qq);
//	Show_Str1(150+12,75,BLUE,YELLOW,"QQ",16,1);
	delay_ms(1200);
}
...
//	TP_Adjust();  		//强制执行一次屏幕校准 (适用于没有IIC存储触摸参数的用户)
	...
	LCD_ShowString1(lcddev.width-24,0,16,"RST",1);//显示清屏区域
