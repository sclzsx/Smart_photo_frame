...
{	  
	POINT_COLOR=RED;
	LCD_ShowString1(40,160,16,"x1:",1);
 	LCD_ShowString1(40+80,160,16,"y1:",1);
 	LCD_ShowString1(40,180,16,"x2:",1);
 	LCD_ShowString1(40+80,180, 16,"y2:",1);
	LCD_ShowString1(40,200, 16,"x3:",1);
 	LCD_ShowString1(40+80,200, 16,"y3:",1);
	LCD_ShowString1(40,220, 16,"x4:",1);
 	LCD_ShowString1(40+80,220, 16,"y4:",1);  
 	LCD_ShowString1(40,240, 16,"fac is:",1);     
...
{								 
	...
	LCD_Clear(WHITE);//清屏 	   
	POINT_COLOR=BLACK;
	LCD_ShowString1(10,40,16,"Please use the stylus click the",1);//显示提示信息
	LCD_ShowString1(10,56,16,"cross on the screen.The cross will",1);//显示提示信息
	LCD_ShowString1(10,72,16,"always move until the screen ",1);//显示提示信息
	LCD_ShowString1(10,88,16,"adjustment is completed.",1);//显示提示信息
				...
				case 4:	 //全部四个点已经得到
					...
					if(abs(tp_dev.xfac)>2||abs(tp_dev.yfac)>2)//触屏和预设的相反了.
					{
						cnt=0;
 				    	TP_Drow_Touch_Point(lcddev.width-20,lcddev.height-20,WHITE);	//清除点4
   	 					TP_Drow_Touch_Point(20,20,RED);								//画点1
						LCD_ShowString1(40,26, 16,"TP Need readjust!",1);
					...
					POINT_COLOR=BLUE;
					LCD_Clear(WHITE);//清屏
					LCD_ShowString1(35,110, 16,"Touch Screen Adjust OK!",1);//校正完成
					delay_ms(1000);
					TP_Save_Adjdata();  
 					LCD_Clear(WHITE);//清屏   
					return;//校正完成				 
